...
e = [
  ...
  },
  {
    ...
    caller: 'Sue Rosen',
    link: [
      'https://www.facebook.com/events/1152126988838194/',
      'https://www.meetup.com/bida-contra-dance/events/291536606/'
    ]
  },
  {
    date: [2023, 3, 5],
    ...
    link: [
      'https://www.facebook.com/events/2501663259971407/',
      'https://www.meetup.com/bida-contra-dance/events/291909567/'
    ]
  },
  {
    date: [2023, 3, 10],
  ...
  },
  {
    ...
    link: [
      'https://www.facebook.com/events/225262179908499/',
      'https://www.meetup.com/bida-contra-dance/events/292170917/'
    ]
  },
  {
    date: [2023, 3, 26],
    ...
    link: [
      'https://www.facebook.com/events/1284836469047062/',
      'https://www.meetup.com/bida-contra-dance/events/291685974/'
    ]
  },
  {
    date: [2023, 3, 27],
  ...
  },
  {
    ...
    caller: 'Bob Isaacs',
    link: [
      'https://www.facebook.com/events/670004571794355/',
      'https://www.meetup.com/bida-contra-dance/events/292390815/'
    ]
  },
  {
    date: [2023, 4, 16],
    ...
    caller: 'Don Veino',
    link: [
      'https://www.facebook.com/events/751389736363162',
      'https://www.meetup.com/bida-contra-dance/events/292711685/'
    ]
  },
  {
    date: [2023, 5, 7],
    ...
    link: [
      'https://www.facebook.com/events/1225258111711016',
      'https://www.meetup.com/bida-contra-dance/events/293006729/'
    ]
  },
  {
    date: [2023, 5, 21],
    title:
      'Double Dance! Afternoon Advanced Dance, Potluck, & All-levels Evening Dance',
    band: "Calluna: Eileen O'Grady, Gus Cantieni, & Jesse Ball",
    caller: 'Steve Zakon-Anderson',
    link: [
      'https://www.facebook.com/events/787404699486706/',
      'https://www.meetup.com/bida-contra-dance/events/293428934/'
    ],
    html:
      '<table><tr><td>4:00-6:30<td>Advanced dance' +
  ...
  },
  {
    ...
    title: 'Contra Dance + Family Dance',
    link: [
      'https://www.meetup.com/bida-contra-dance/events/293723280/',
      'https://www.facebook.com/events/1388514941881652',
      'https://www.instagram.com/p/CsmfFUarFm_/'
    ],
    html:
  ...
  },
  {
    ...
    caller: 'Liz Nelson',
    link: [
      'https://www.facebook.com/events/626626559423239',
      'https://www.meetup.com/bida-contra-dance/events/294364557/',
      'https://www.instagram.com/p/CuGOnUrr_c6/'
    ],
  ...
  },
  {
    ...
    link: [
      'https://www.facebook.com/events/7078633855497924/',
      'https://www.meetup.com/bida-contra-dance/events/295664014/',
      'https://www.instagram.com/p/CwWDoQ1LLFN/'
    ],
    html: 'This dance is <a href=/accessibility><strong>mask-optional</strong></a>'
  },
  {
...
function gen_events () {
  ...
  for (var i = 0; i < e.length; i++) {
    ...
    event.date = new Date(event.date[0], event.date[1] - 1, event.date[2])
    let links = null
    if (event.link) {
    ...
    if (event.date < yesterday) {
      if (past_events.children.length == 0) {
        ...
        past_events.insertBefore(append_event, past_events.firstChild)
      }
    } else {
